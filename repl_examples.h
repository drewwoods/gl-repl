/*
 * repl_examples.h - Built-in example library.
 *
 ...
 * Example dropdown and by repl_core.c to load and feed examples.
 */
 ...
 * for the lifetime of the program. Used by repl_core.c to load examples. */
