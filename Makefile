...
SRCS = sample.c repl_core.c repl_state.c repl_command_spec.c repl_parser.c repl_source_scope.c repl_command_store.c repl_commit.c repl_clipboard.c repl_undo.c repl_camera_controls.c repl_actions.c repl_code_panel_layout.c repl_code_panel_document.c repl_flatten.c repl_executor.c repl_autocomplete.c ui_autocomplete_panel.c repl_autonormal.c repl_scenes.c repl_example_loader.c repl_replay.c repl_replay_annotations.c repl_search.c repl_export.c repl_editor.c repl_examples.c scene_render.c scene_backdrop.c scene_lights.c scene_overlays.c ui_panels.c ui_menu_bar.c ui_color_picker.c ui_help_overlay.c ui_variable_panel.c repl_var_drag.c repl_inline_rename.c repl_eval.c cmd_format.c repl_audio.c ui_profile_panel.c gl_stub_counts.c
HDRS = sample.h repl_state.h repl_core.h repl_core_internal.h repl_command_spec.h repl_parser.h repl_source_scope.h repl_command_store.h repl_clipboard.h repl_undo.h repl_camera_controls.h repl_actions.h repl_code_panel_layout.h repl_code_panel_document.h repl_replay.h repl_replay_annotations.h repl_examples.h scene_render.h scene_backdrop.h scene_lights.h scene_overlays.h ui_panels.h ui_menu_bar.h ui_color_picker.h ui_help_overlay.h ui_variable_panel.h repl_var_drag.h ui_autocomplete_panel.h repl_inline_rename.h repl_eval.h cmd_format.h repl_audio.h ui_profile_panel.h
CORE_TEST_SRCS = repl_core.c repl_state.c repl_command_spec.c repl_parser.c repl_source_scope.c repl_command_store.c repl_commit.c repl_clipboard.c repl_undo.c repl_camera_controls.c repl_actions.c repl_code_panel_layout.c repl_code_panel_document.c repl_flatten.c repl_executor.c repl_autocomplete.c ui_autocomplete_panel.c repl_autonormal.c repl_scenes.c repl_example_loader.c repl_replay.c repl_replay_annotations.c repl_search.c repl_export.c repl_editor.c repl_examples.c scene_render.c scene_backdrop.c scene_lights.c scene_overlays.c ui_panels.c ui_menu_bar.c ui_color_picker.c ui_help_overlay.c ui_variable_panel.c repl_var_drag.c repl_inline_rename.c repl_eval.c cmd_format.c repl_audio.c ui_profile_panel.c gl_stub_counts.c
