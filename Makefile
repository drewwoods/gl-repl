...
REPL_DEMO_DEP_SRCS = cmd_format.c \
                     ...
                     repl_source_scope.c \
                     repl_state.c \
                     glr_source_document.c glr_code_annotations.c \
                     src/editor/state.c \
