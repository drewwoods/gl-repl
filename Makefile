...
SRCS = sample.c repl_core.c repl_state.c repl_command_spec.c repl_command_store.c repl_flatten.c repl_executor.c repl_autocomplete.c repl_replay.c repl_search.c repl_export.c repl_editor.c repl_examples.c scene_render.c ui_panels.c repl_eval.c cmd_format.c repl_audio.c profile_panel.c gl_stub_counts.c
...
CORE_TEST_SRCS = repl_core.c repl_state.c repl_command_spec.c repl_command_store.c repl_flatten.c repl_executor.c repl_autocomplete.c repl_replay.c repl_search.c repl_export.c repl_editor.c repl_examples.c scene_render.c ui_panels.c repl_eval.c cmd_format.c repl_audio.c profile_panel.c gl_stub_counts.c
