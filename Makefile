...
check-state-ownership: ## Run state-ownership contract checks (new + tightened existing checks).
	...
	for target in \
		...
		check-imrepl-not-editor-mirror; do \
