...
static const char *g_example_stress[] = {
    ...
    "func2(radius, hole) {",
        ...
        "for(i, 0, 20) {",
            ...
            "gluVertex(n*cos(i*TAU/20), 0, n*sin(i*TAU/20));",
        "}",
        "gluEnd();",
        "// Inner contour: circular cutout (opposite winding)",
        "gluBegin(GLU_CONTOUR);",
        "for(i, 0, 24) {",
    ...
    "for(i, 0, 120) {",
        ...
        "glColor4f(0.1 + 0.5*sin(i*0.08 + t), 0.9 - 0.4*cos(i*0.06), 0.5 + 0.3*sin(i*0.12 + t*0.5), 0.4 + 0.6*i/120);",
        "glVertex3f(x, y, z);",
    "}",
    "glEnd();",
    "glEnable(GL_LIGHTING);",
