/*
 * repl_util.h - Small inline utilities used across REPL pipeline TUs.
 *
 ...
 * so consumers don't have to include the full repl_core_internal.h
 * surface just to get a safe printf into a fixed buffer.
 *
 * Phase 5 of feature/source-document-port.md split these out of
 * repl_core_internal.h. The latter still pulls this header in for
