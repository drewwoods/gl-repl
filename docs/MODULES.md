...
- **UI is view + hit-test, not a controller.** Renderers consume
  [`UiRenderSnapshot`](../src/ui/app/snapshot.h#L89). Input handlers compute a [`UiHit`](../src/ui/core/hit.h#L60) and return.
...
- **`make editor-demo`** (`tools/editor_demo/`) - a generic
  ...
  **not** link `src/ui/app`: the demo proves the editor model can render
  ...
  [`UiRenderSnapshot`](../src/ui/app/snapshot.h#L89), menu bar, app chrome, or [`UiState`](../src/ui/app/state.h#L20). The demo is
...
| `ui_snapshot` | Defines [`UiRenderSnapshot`](../src/ui/app/snapshot.h#L89), the read-only bundle passed to every UI renderer |
