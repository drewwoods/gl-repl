...
- **`make editor-demo`** (`tools/editor_demo/`) — a generic
  ...
  **not** link `src/ui/app`: the demo proves the editor model can render
  ...
  [`UiRenderSnapshot`](../src/ui/app/snapshot.h#L82), menu bar, app chrome, or [`UiState`](../src/ui/app/state.h#L20). The demo is
