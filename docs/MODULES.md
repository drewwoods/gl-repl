...
- **Legacy GL/eval domain types** in `src/repl/` (cross-domain,
  deliberately un-prefixed): [`GLCmd`](../src/repl/command.h#L97), [`CmdType`](../src/repl/command.h#L37), [`ExprVar`](../src/repl/eval.h#L136), [`ExprCtx`](../src/repl/eval.h#L143),
...
| `repl_command_store` | Low-level [`GLCmd`](../src/repl/command.h#L97) array mechanics only: insert, replace, delete, load. No text-buffer writes |
...
[`GLCmd`](../src/repl/command.h#L97) is a parse-result record: type, args, flags, provenance. It does
