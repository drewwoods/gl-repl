...
- **UI is view + hit-test, not a controller.** Renderers consume
  [`UiRenderSnapshot`](../src/ui/app/snapshot.h#L85). Input handlers compute a [`UiHit`](../src/ui/core/hit.h#L60) and return.
...
- **`make editor-demo`** (`tools/editor_demo/`) - a generic
  ...
  **not** link `src/ui/app`: the demo proves the editor model can render
  ...
  [`UiRenderSnapshot`](../src/ui/app/snapshot.h#L85), menu bar, app chrome, or [`UiState`](../src/ui/app/state.h#L20). The demo is
...
| Module | Role |
|--------|------|
| `boot/glr_cli` | argv → [`GlrCliOptions`](../src/app/boot/glr_cli.h#L32) bag; usage/`--list-*` exit paths, `--examples-dir` load, fail-fast name→index resolution for `--example` / `--tour` |
...
| `ui_snapshot` | Defines [`UiRenderSnapshot`](../src/ui/app/snapshot.h#L85), the read-only bundle passed to every UI renderer |
