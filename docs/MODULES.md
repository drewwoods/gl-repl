...
| Module | Role |
|--------|------|
| `boot/glr_cli` | argv → [`GlrCliOptions`](../src/app/boot/glr_cli.h#L32) bag; usage/`--list-*` exit paths, `--examples-dir` load, fail-fast name→index resolution for `--example` / `--tutorial` / `--tour` |
