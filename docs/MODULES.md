...
| [`ReplayRuntimeState`](../src/subsystems/replay/replay_state.h#L96) (peer) | Replay state machine: PC, mode, speed, accum, fade speed, src_line_idx, total_flat_cmds, code expansion mode, normal display, focused-vertex label | Editor text behavior, REPL grammar |
