...
| `src/app/glr_prof` | Profile-section policy: the display table behind [`prof_section_info()`](../src/support/cpuprof.h#L159) plus which sections get GPU timer queries bracketed around them (GL-free sections stay CPU-only) |
