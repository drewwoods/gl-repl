...
flowchart TB
    ...
    app["<b>0. App shell</b><br/><b>controller band:</b> glr_ctrl broad coordinator · _router · _view_transition<br/>glr_state · glr_actions · glr_config · glr_prof · glr_paths · glr_workspaces · glr_modal · glr_web_io<br/>bridges: glr_source_document · glr_camera_export · glr_color_picker_bridge · glr_clipboard<br/>glr_compositor · glr_audio · tours (glr_tours · _pointer_script · _tour_snapshot)<br/><b>boot band:</b> glr_cli · glr_boot_dumps · glr_init_trace · glr_capture_env ·<br/>glr_frame_pacer · splash<br/>(owns app presentation/render state; target is thinner routing)"]
