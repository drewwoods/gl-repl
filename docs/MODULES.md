...
- **State has explicit owners.** [`ReplRuntimeState`](../src/repl/state.h#L18) is the REPL program runtime.
  ...
  chrome. [`Render3dState`](../src/render3d/render.h#L88) is the render3d renderer's frame-to-frame
...
| `src/repl/import` | Reverses the exporter line-by-line, feeding geometry through [`editor_feed_line()`](../src/editor/input.h#L196). The `IMPORT_EXPORT_STATE` macro block is duplicated verbatim between the two TUs on purpose |
