...
| [`ReplayRuntimeState`](../src/subsystems/replay/replay_state.h#L82) (peer) | Replay state machine: PC, mode, speed, accum, fade speed, src_line_idx, total_flat_cmds, expand_args, normal display | Editor text behavior, REPL grammar |
