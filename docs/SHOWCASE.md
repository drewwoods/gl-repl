...
<!--
  ...
  images/). New captures referenced below live under
  images/showcase/ and are recorded headlessly:
...
<!-- PLACEHOLDER images/showcase/torus-knot.gif
...
<!-- PLACEHOLDER images/showcase/snowfall.gif
...
<!-- PLACEHOLDER images/showcase/parametric-torus.gif
...
<div align="center">
<img src="images/showcase/parametric-torus.gif" alt="A shaded parametric torus built from quad strips" width="70%">
</div>
...
<!-- PLACEHOLDER images/showcase/recursive-tree.gif
...
<!-- PLACEHOLDER images/showcase/spirograph.gif
...
<!-- PLACEHOLDER images/showcase/ripple-ring.gif
...
<!-- PLACEHOLDER images/showcase/bezier.png
...
<!-- PLACEHOLDER images/showcase/de-casteljau.png
...
<!-- PLACEHOLDER images/showcase/orbit-plot.png
...
<!-- PLACEHOLDER images/showcase/wave-surface.gif
...
<!-- PLACEHOLDER images/showcase/terrain.gif
     scripts/record-gif.sh --example "Procedural terrain (rand grid + sin ripple)" --duration 5 --out terrain -->
<img src="images/showcase/terrain.gif" alt="Procedural terrain grid" width="100%">
...
<!-- PLACEHOLDER images/showcase/lit-cube.png
...
<!-- PLACEHOLDER images/showcase/grass.gif
...
<!-- PLACEHOLDER images/showcase/jellyfish.gif
...
<!-- PLACEHOLDER images/showcase/function-demo.png
...
<!-- PLACEHOLDER images/showcase/function-polygons.png
...
<!-- PLACEHOLDER images/showcase/conditional-colors.gif
...
<!-- PLACEHOLDER images/showcase/whale.gif
...
<!-- PLACEHOLDER images/showcase/stress-test.gif
     scripts/record-gif.sh --example "Stress test (all features)" --duration 6 --out stress-test -->
<img src="images/showcase/stress-test.gif" alt="All-features stress test" width="100%">
...
<!-- PLACEHOLDER images/showcase/feature-time.gif
...
<img src="images/showcase/feature-time.gif" alt="Toggling the time variable" width="100%">
...
<!-- PLACEHOLDER images/showcase/feature-sliders.gif
     Shot: dragging a variable-panel slider while the scene responds live.
     Interactive recording; images/variable-panel.png is the still
     stand-in until then. -->
...
<!-- PLACEHOLDER images/showcase/feature-ply.png
...
<img src="images/showcase/feature-ply.png" alt="Exported PLY mesh in an external tool" width="100%">
...
<!-- PLACEHOLDER images/showcase/feature-export-c.png
     Shot: the exported output.c open in an editor beside the running
     standalone binary — "it round-trips" in one image. -->
<img src="images/showcase/feature-export-c.png" alt="Saving to standalone C" width="100%">
