...
| `V`, `VERBOSE` | Makefile. | `1` restores verbose compiler commands and diagnostics; the default prints one timed line per compiled C file and a longest-step summary. |
