...
per-pass data belongs in [`Render3dFrameRenderContext`](../src/render3d/render_types.h#L354), for example camera world height,
...
membership predicate is [`repl_cmd_is_glut_solid()`](../src/repl/command.h#L335) in [`src/repl/command.h`](../src/repl/command.h)
...
domain tags. Top-level visible rows are tags ([`repl_tutorial_visible_tag_count()`](../src/repl/tutorials.h#L353)
...
Target rule: `render3d_*` files consume [`Render3dRenderConfig`](../src/render3d/render_types.h#L139), [`Render3dFrameRenderContext`](../src/render3d/render_types.h#L354),
...
Tutorial step kinds ([`TutorialStepKind`](../src/repl/tutorials.h#L135) in [`src/repl/tutorials.h`](../src/repl/tutorials.h)) name the
...
- Add the new enum value to [`TutorialStepKind`](../src/repl/tutorials.h#L135).
- Add any extra fields to [`TutorialStep`](../src/repl/tutorials.h#L135). **Place new fields AFTER all
