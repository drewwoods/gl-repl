...
env-capture run kind (`GLR_POINTER_SCRIPT`), distinguished by a [`PsRunKind`](../src/app/glr_pointer_script.c#L157)
...
* **Virtual clock vs rendered frames.** The host schedules
  ...
  stage drives [`glr_pointer_script_frame()`](../src/app/glr_pointer_script.h#L241),
...
* **Event accounting.** `g_next_event` / `g_current_event` / `g_completed_events`
  ...
  [`PsWait`](../src/app/glr_pointer_script.c#L211) completing does (immediate verbs complete the following virtual
...
* **HUD.** The controller populates `snap->tour` from
  [`glr_pointer_script_tour_view()`](../src/app/glr_pointer_script.h#L162) and renders
