...
env-capture run kind (`GLR_POINTER_SCRIPT`), distinguished by a [`PsRunKind`](../src/app/glr_pointer_script.c#L152)
...
* **Virtual clock vs rendered frames.** The host schedules
  ...
  stage drives [`glr_pointer_script_frame()`](../src/app/glr_pointer_script.h#L238),
...
* **Event accounting.** `g_next_event` / `g_current_event` / `g_completed_events`
  ...
  [`PsWait`](../src/app/glr_pointer_script.c#L202) completing does (immediate verbs complete the following virtual
...
* **HUD.** The controller populates `snap->tour` from
  [`glr_pointer_script_tour_view()`](../src/app/glr_pointer_script.h#L159) and renders
