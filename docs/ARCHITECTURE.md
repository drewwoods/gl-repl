...
| Seam | Purpose |
|---|---|
| Config bridge | [`glr_actions_install_export_cfg_bridge()`](../src/app/glr_actions.h#L126) exposes `@cfg` reads and writes without coupling export to app config modules. |
