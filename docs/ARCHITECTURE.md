...
[`glr_frame_begin()`](../src/app/glr_ctrl.h#L241) /
[`glr_frame_work_end()`](../src/app/glr_ctrl.h#L245) /
[`glr_frame_ended()`](../src/app/glr_ctrl.h#L246) calls bracket `gl_repl.c`'s
...
[`glr_ctrl_build_ui_snapshot()`](../src/app/glr_ctrl.h#L134) and passes to every `ui_*_render*()`
...
* **Baseline + prefix replay.** Backstep does **not** snapshot every event. One
  ...
  [`glr_ctrl_after_tour_restore()`](../src/app/glr_ctrl.h#L97) to re-sync derived chrome + export strings,
...
- **Reset:** [`repl_state_reset_program()`](../src/repl/state_owners.h#L123) resets core REPL
  state. [`glr_ctrl_reset_all()`](../src/app/glr_ctrl.h#L82) resets the editor, UI, and peer
...
[`glr_ctrl_display_frame()`](../src/app/glr_ctrl.h#L248) (snapshot/follow-scroll → render3d render →
...
* **Code panel (per frame):** the controller resolves the block once in
  [`glr_ctrl_build_ui_snapshot()`](../src/app/glr_ctrl.h#L134) into
...
4. Extend the ownership tests in the same change: keep
   ...
   [`repl_state_reset_program()`](../src/repl/state_owners.h#L123) (REPL-only) / [`glr_ctrl_reset_all()`](../src/app/glr_ctrl.h#L82)
