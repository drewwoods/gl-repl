...
static inline void glTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels) { GL_STUB_TRACE_LINE("glTexSubImage2D %u %d %d %d %d %d\n", (unsigned)target, (int)level, (int)xoffset, (int)yoffset, (int)width, (int)height); gl_stub_tick(GL_STUB_glTexSubImage2D); (void)format; (void)type; (void)pixels; }
