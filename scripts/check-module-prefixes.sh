...
#
# The module-naming cleanup (plans/in-review/module-naming-convention.md)
...
if [ -n "$violations" ]; then
    ...
    echo "plans/in-review/module-naming-convention.md and the" >&2
    echo "Sanctioned Exceptions / Conventions in MODULES.md." >&2
    echo "Hits:" >&2
    printf '%s\n' "$violations" >&2
    exit 1
fi
