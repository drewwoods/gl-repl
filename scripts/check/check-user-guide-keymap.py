...
CLAIMS: list[tuple[str, str, list[str]]] = [
    ...
    ("Variable panel shortcut", "GLR_VARIABLE_PANEL",
     ["Toggle the panel with **{key}** backquote",
      "| {key} | Variable panel |"]),
    ...
    ("Vertex labels shortcut", "GLR_VERTEX_LABELS",
     ["| {key} | Vertex labels |",
      "**Vertex labels** ({key})"]),
    ("Label scope shortcut", "GLR_VERTEX_LABEL_SCOPE",
     ["| {key} | Label scope |",
      "**Label scope** ({key})"]),
    ...
    ("Accum effect shortcut", "GLR_ACCUM_EFFECT",
     ["**Accum effect** ({key})",
      "| {key} | Accum effect |"]),
    ("Xform guides shortcut", "GLR_XFORM_GUIDES",
     ["With **Xform guides** on ({key})",
      "| {key} | Xform guides |"]),
...
FORBIDDEN_PATTERNS: list[tuple[str, str]] = [
    ...
    ("stale vertex outlines Ctrl+Shift+E", "Ctrl+Shift+E"),
