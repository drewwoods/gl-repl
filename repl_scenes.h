/*
 * repl_scenes.h - User-scene promotion, capture, and reset API.
 *
 * The user-scene model lives in repl_scenes.c (slots + LRU eviction +
 ...
 * count / names / load / active) live on repl_core.h; THIS file
 ...
 * repl_core_internal.h so the "core internal" header can shrink
