...
static void print_usage(const char *prog) {
    ...
    fprintf(stdout,
            ...
            "               assignment row (0-based); further rows join as\n"
            "               extra series, up to four. Poses the panel for\n"
            "               captures - it otherwise needs a right-click.\n"
            "  GLR_OPEN_COMMAND_HELP=<n>[,<dx>]  Right-click a committed GL\n"
            "               row to raise its help card (0-based); dx slides\n"
            "               the card right by that many pixels. Posed after\n"
            "               the assignment plot - clicking an assignment row\n"
            "               closes the card.\n"
