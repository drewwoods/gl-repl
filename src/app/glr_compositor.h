 ...
 * which runs inside scene_render_3d_scene() over the scene viewport rect
 ...
 * standalone scene_demo), while this hook is an app concern operating on
 * the final framebuffer.
 *
 * The effect vocabulary is shared (ScenePostFilterMode). The chromatic
 ...
 * SCENE_POST_FILTER_OFF, an out-of-range mode, or non-positive
