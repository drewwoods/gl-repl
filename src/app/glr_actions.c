...
static const GlrCfgSceneDefault k_cfg_scene_defaults[] = {
    { .key = GLR_CONFIG_WIREFRAME,              .value = CFG_DEFAULT_WIREFRAME              },
    { .key = GLR_CONFIG_GRID_THEME,             .value = CFG_DEFAULT_GRID_THEME             },
    { .key = GLR_CONFIG_GRID_MAJOR,             .value = CFG_DEFAULT_GRID_MAJOR_IDX         },
    { .key = GLR_CONFIG_GRID_EXTENT,            .value = CFG_DEFAULT_GRID_EXTENT_IDX        },
    { .key = GLR_CONFIG_GRID_BRIGHTNESS,        .value = CFG_DEFAULT_GRID_BRIGHTNESS_IDX    },
    { .key = GLR_CONFIG_AXES_THEME,             .value = CFG_DEFAULT_AXES_THEME             },
    { .key = GLR_CONFIG_VERTEX_LABELS,          .value = CFG_DEFAULT_VERTEX_LABELS          },
    { .key = GLR_CONFIG_VERTEX_LABEL_PLACEMENT, .value = CFG_DEFAULT_VERTEX_LABEL_PLACEMENT },
    { .key = GLR_CONFIG_OVERLAY_SCOPE,          .value = CFG_DEFAULT_OVERLAY_SCOPE          },
    { .key = GLR_CONFIG_NORMAL_VECTORS,         .value = CFG_DEFAULT_NORMAL_VECTORS         },
    { .key = GLR_CONFIG_VERTEX_OUTLINES,        .value = CFG_DEFAULT_VERTEX_OUTLINES        },
    { .key = GLR_CONFIG_VERTEX_OUTLINE_STYLE,   .value = CFG_DEFAULT_VERTEX_OUTLINE_STYLE   },
    { .key = GLR_CONFIG_VERTEX_POINTS,          .value = CFG_DEFAULT_VERTEX_POINTS          },
    { .key = GLR_CONFIG_POLY_HIGHLIGHT,         .value = CFG_DEFAULT_HIGHLIGHT_POLY         },
    { .key = GLR_CONFIG_XFORM_GUIDE_MODE,       .value = CFG_DEFAULT_XFORM_GUIDE_MODE       },
    { .key = GLR_CONFIG_LIGHT_INDICATORS,       .value = CFG_DEFAULT_LIGHT_INDICATORS       },
    { .key = GLR_CONFIG_LIGHT_THEME,            .value = CFG_DEFAULT_LIGHT_THEME            },
    { .key = GLR_CONFIG_BACKDROP,               .value = CFG_DEFAULT_BACKDROP_MODE          },
    { .key = GLR_CONFIG_ORTHO_MODE,             .value = CFG_DEFAULT_ORTHO_MODE             },
    { .key = GLR_CONFIG_PROJECTION,             .value = CFG_DEFAULT_PROJECTION             },
    { .key = GLR_CONFIG_CAMERA_ROTATE,          .value = CFG_DEFAULT_CAMERA_ROTATE          },
    { .key = GLR_CONFIG_VARIABLE_PANEL,         .value = CFG_DEFAULT_VARIABLE_PANEL         },
};
