...
2. builds a [`Render3dRenderConfig`](../render3d/render_types.h#L138) from REPL runtime state + view state and calls
   [`glr_camera_load_modelview()`](glr_camera.h#L165) then [`render3d_draw_scene()`](../render3d/render.h#L139) (with the
   owned [`Render3dState`](../render3d/render.h#L101), once per accumulation-jitter sample);
