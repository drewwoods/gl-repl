...
code-panel adapter, menu bar, [`UiRenderSnapshot`](../ui/app/snapshot.h#L70), [`UiState`](../ui/app/state.h#L20), and app chrome are
...
The editor owns the **canonical per-line text**; [`GLCmd`](../repl/command.h#L88) in `src/repl`
