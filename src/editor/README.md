...
- **Generic, application-free core.** [`state.c`](state.c) owns the document
  ([`EditorState`](state.h#L200): buffer, cursor, selection, scroll, undo, ...) and
...
| File | Responsibility |
|---|---|
| [`state.c`](state.c) / `.h` | Owns [`EditorState`](state.h#L200): buffer, input, cursor, selection, scroll, search, autocomplete, undo, cursor blink |
