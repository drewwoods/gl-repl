...
static const ReplFuncCompletion k_func_completions[] = {
    ...
    { "glVertex4f(",         "glVertex4f(x, y, z, w)",                                   4, { "x", "y", "z", "w" },
        "Specify a homogeneous vertex position", REPL_HELP_GROUP_GEOMETRY },
...
static const ReplStdCommandSpec k_std_command_specs[] = {
    ...
    { "glVertex4f",       CMD_VERTEX4F,              4, "glVertex4f(%g, %g, %g, %g);",        "Usage: glVertex4f(x, y, z, w)",                      0 },
...
static const ReplCommandTypeSpec g_command_type_specs[CMD_TYPE_COUNT] = {
    ...
    CMD_TYPE_SPEC(CMD_VERTEX4F,                     1, CMD_CAT_VERTEX),
    ...
    CMD_TYPE_SPEC(CMD_SCRATCH_BLOCK_ASSIGN,         1, CMD_CAT_VARIABLE),
