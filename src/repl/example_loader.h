/*
 * src/repl/example_loader.h - Example loader public surface.
 *
 * Production code calls `repl_load_example(int)` (declared in
 * src/repl/core.h) — the public entry point with all side effects (scene
 ...
 * src/repl/core_internal.h so the catch-all "core internal" header can
