/*
 * src/repl/autonormal.c -- Auto-generated normal commands.
 *
 * The cursor-context source/flat queries that used to share this file live in
 * geometry_query.c, next to the header that declares them.
 */
#include <stdio.h>
#include <string.h>
