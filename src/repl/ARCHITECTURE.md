...
([`repl_state_flat_program_local_vars()`](state_views.h#L192)):
...
| [`ReplSceneRuntimeState`](state_views.h#L154) | active example index, bound workspace dir |
| [`ReplImportExportState`](state_views.h#L164) | cached header/render/camera text + pending import metadata |
