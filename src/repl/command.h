 ...
 *
 * MAX_EDITOR_COMMANDS / MAX_LINE_LEN moved to config.h (the neutral limits
...
typedef enum {
    CMD_BEGIN, CMD_END,
    CMD_VERTEX3F, CMD_VERTEX2F, CMD_VERTEX4F,
    CMD_NORMAL3F,
    ...
    CMD_BREAK, CMD_CONTINUE, CMD_RETURN,
 ...
 * that *contribute a vertex* (glVertex3f / glVertex2f / glVertex4f /
 * gluVertex);
