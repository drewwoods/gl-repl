...
static void render3d_scene_pass(const Render3dState *state,
    ...
    if (config->buffer_pass_overlay_fn)
        config->buffer_pass_overlay_fn(config->buffer_pass_overlay_user_data,
                                       is_final_pass,
                                       config->render3d_x, config->render3d_y,
                                       config->render3d_w, config->render3d_h);
...
int render3d_draw_scene(Render3dState *state,
    ...
    if (config->buffer_resolve_overlay_fn)
        config->buffer_resolve_overlay_fn(
            config->buffer_resolve_overlay_user_data,
