...
1. State lives in the subsystem's own `*_state.c` (e.g.
   [`ReplayRuntimeState`](replay/replay_state.h#L83), the variable-panel drag transaction, the
...
| [`replay/replay_state.c`](replay/replay_state.c) / `.h` | Owns [`ReplayRuntimeState`](replay/replay_state.h#L83) storage + narrow accessors / snapshot view |
