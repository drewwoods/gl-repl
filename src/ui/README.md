...
- **A UI renderer may draw.** It takes a read-only snapshot
  ([`UiRenderSnapshot`](app/snapshot.h#L89)) and produces pixels. It does not read live program or
...
controller ([`src/app/glr_ctrl.c`](../app/glr_ctrl.c)) builds a [`UiRenderSnapshot`](app/snapshot.h#L89) from
...
| [`app/snapshot.h`](app/snapshot.h) | [`UiRenderSnapshot`](app/snapshot.h#L89) - the read-only per-frame bundle every renderer takes |
