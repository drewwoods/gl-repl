...
- **A UI renderer may draw.** It takes a read-only snapshot
  ([`UiRenderSnapshot`](app/snapshot.h#L92)) and produces pixels. It does not read live program or
...
controller ([`src/app/glr_ctrl.c`](../app/glr_ctrl.c)) builds a [`UiRenderSnapshot`](app/snapshot.h#L92) from
REPL runtime state + [`EditorState`](../editor/state.h#L207) + [`UiState`](app/state.h#L20) + peer state and fans it out to the
...
| [`app/snapshot.h`](app/snapshot.h) | [`UiRenderSnapshot`](app/snapshot.h#L92) - the read-only per-frame bundle every renderer takes |
