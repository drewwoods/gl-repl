...
buffer, not on [`GLCmd`](src/repl/command.h#L109)**) → flat array (loops unrolled, funcs inlined, ifs
...
- [`GLCmd`](src/repl/command.h#L109) payload is a tagged union keyed on `type` (`payload.decl.*`,
