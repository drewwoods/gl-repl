...
| [`src/render3d/render_types.h`](src/render3d/render_types.h) | Shared [`Render3dRgba`](src/render3d/render_types.h#L59) / [`Render3dRenderConfig`](src/render3d/render_types.h#L131) / [`Render3dFrameRenderContext`](src/render3d/render_types.h#L289) types for scene helpers |
...
- **In-flyout subheading grouping.** A tutorial may declare an optional
  ...
  + [`CatalogFlyoutOps`](src/ui/app/menu_bar.c#L230) vtable, shared with the Scene example flyout
