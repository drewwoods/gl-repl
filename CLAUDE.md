...
program if dirty → build [`Render3dRenderConfig`](src/render3d/render_types.h#L138) → clear chrome + load camera
...
[`Render3dState`](src/render3d/render.h#L101) layout change still needs a relaunch).
